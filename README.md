...
> [!TIP]
> Если вы внутри приложения сохраняете какой-либо свой токен работы с пользователем - лучше всего передавать его через заголовок, например Authorization
> 
> Многие браузеры запрещают использование Cookies в iframe и авторизация в миниприложении ломается  
> (Очень актуально в Edge, Brave, Chrome Инкогнито)
